...
df_veiligheidsregio = df[df['Region_level']=='Veiligheidsregio'].reset_index(drop=True)
             ...
             [
                 ...
                 dbc.CardBody([
                     ...
                     dbc.Col(dash_table.DataTable(id='vaccination_table',
                                columns=[{'id': key, 'name': column_dict[key]} for key in column_dict.keys()],
                                page_size=200,
                                style_table={'height': '800px', 'whiteSpace': 'normal'},
