            ...
            html.A(
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(dbc.NavbarBrand("Covid19 Dashboard Nederland")),
                    ],
                    align="center",
                    className="g-0",
                ),
    ...
    [
        ...
        dbc.Nav(
            [   dbc.NavLink("Covid Cijfers", href=pages[0]["path"], active="exact"),
                dbc.NavLink("Vaccinatie Cijfers", href=pages[2]["path"], active="exact"),
                dbc.NavLink("Databronnen", href=pages[1]["path"], active="exact"),
